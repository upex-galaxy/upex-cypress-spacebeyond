...
4. Tener el Markdown de la US en la carpeta **coverage** en su correspondiente carpeta Sprint, ejemplo: <br> `coverage/userStory.md`<br> Esto implica que cada vez que se trabaje en un Sprint nuevo, se debería crear la carpeta correspondiente **"S"** + **número del sprint**, como se muestra en el ejemplo arriba.
